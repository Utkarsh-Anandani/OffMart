...
export const initialMessages: Message[] = [
  {
    ...
    id: "0",
    content:
      "Hi! I am your PDF assistant. I am happy to help with your questions about your uploaded documents.",
  },
];
...
export const getSources = (data: Data[], role: "function" | "system" | "user" | "assistant", index: number) => {
